...
public final class FragmentProfileViewBinding implements ViewBinding {
  ...
  private FragmentProfileViewBinding(@NonNull FrameLayout rootView, @NonNull ImageButton btnBack2,
      ...
      @NonNull TextView textView5, @NonNull TextView tvLogout, @NonNull TextView tvPassword,
      @NonNull TextView tvStoreName, @NonNull TextView tvUsername, @NonNull View view,
  ...
  public static FragmentProfileViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileViewBinding((FrameLayout) rootView, btnBack2,
          btnChangePasswordDetails, btnChangeProfileDetails, circularImageView, imageView5,
          textView2, textView3, textView4, textView5, tvLogout, tvPassword, tvStoreName, tvUsername,
