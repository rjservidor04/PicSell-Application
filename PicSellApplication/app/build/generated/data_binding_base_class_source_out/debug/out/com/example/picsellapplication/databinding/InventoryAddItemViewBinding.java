...
public final class InventoryAddItemViewBinding implements ViewBinding {
  @NonNull
  ...
  private InventoryAddItemViewBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static InventoryAddItemViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static InventoryAddItemViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.inventory_add_item_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static InventoryAddItemViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new InventoryAddItemViewBinding((ConstraintLayout) rootView, addinventoryitemView,
