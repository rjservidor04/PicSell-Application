...
public final class InventoryViewItemDetailsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static InventoryViewItemDetailsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static InventoryViewItemDetailsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.inventory_view_item_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static InventoryViewItemDetailsBinding bind(@NonNull View rootView) {
