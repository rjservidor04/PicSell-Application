...
public final class CheckoutViewBinding implements ViewBinding {
  @NonNull
  ...
  private CheckoutViewBinding(@NonNull FrameLayout rootView, @NonNull Button btnCheckout,
  ...
  @NonNull
  public static CheckoutViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CheckoutViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.checkout_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CheckoutViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CheckoutViewBinding((FrameLayout) rootView, btnCheckout, btnTakePicture, etItem,
          etQuantity, ftvItem, ftvQuantity, imgViewPicture);
    }
