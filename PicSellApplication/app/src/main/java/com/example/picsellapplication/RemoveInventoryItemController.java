...
public class RemoveInventoryItemController extends RecyclerView.Adapter<RemoveInventoryItemController.ViewHolder> {
    private ArrayList<InventoryModel> inventoryModelArrayList;
    private Context context;
    // constructor
    public RemoveInventoryItemController(ArrayList<InventoryModel> inventoryModelArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, RemoveInventoryItemView.class);
